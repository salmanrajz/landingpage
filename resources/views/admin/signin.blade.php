@extends('layouts.admin_main_body',['title' => 'Caryaati | Admin Signin'])
										...
										<div class="card-sigin">
											<div class="card-sigin">
												<div class="card-sigin d-flex mb-5">
													<a href="javascript:;"><img src="{{asset('assets/logo.png')}}" class="sign-favicon-a ht-40" alt="logo">
														<img src="{{asset('assets/logo.png')}}" class="sign-favicon-b ht-40" alt="logo">
														</a>
														<h1 class="main-logo1 ms-1 me-0 my-auto tx-28 ps-1">Caryaati</h1>
												</div>
												<div class="card-sigin">
												<div class="main-signup-header">
													<h2>Welcome back!</h2>
													<h5 class="fw-semibold mb-4">Please sign in to continue.</h5>
													<form action="" id="signin_forms">
                                                      ...
                                                      <div class="form-group" id="load_error">
                                                      </div>

                                                        <button class="btn btn-main-primary btn-block" type="button" onclick="SavingData(1,'signin_forms','signin_id','{{route('signin')}}','no_modal','{{route('test')}}','load_error','Sign In Successfull !!','redirect')" id="signin_id">Sign In</button>
													...
													<div class="main-signin-footer mt-5">
														...
														<p class="hidden">Don't have an account? <a href="page-signup.html">Create an Account</a></p>
													</div>
												</div>
											</div>
										</div>
